...
Principal::Principal():
    ...
    Simao(3, 10, 1976, "Simao")
    {
        ...
        UTFPR.set_Departamento(&MODA, 0);
        UTFPR.set_Departamento(&DAINF, 1);
        UTFPR.set_Departamento(&DAFIS, 2);
        Princeton.set_Departamento(&Fisica_Princeton, 0);
        Cambridge.set_Departamento(&Matematica_Cambridge, 0);
    }
Principal::~Principal()
{
